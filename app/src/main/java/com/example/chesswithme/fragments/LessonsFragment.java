...
public class LessonsFragment extends Fragment {
    ...
    private void setInitialData(){
        ...
        data.add(new LessonItem("1", "1", "Pawn", "Как ходят шахматные фигуры: пешка", R.drawable.pawn_white, false, -1, completed_lessons));
        data.add(new LessonItem("2", "1", "King", "Как ходят шахматные фигуры: король", R.drawable.king_white, false, -1, completed_lessons));
        data.add(new LessonItem("3", "1", "Bishop", "Как ходят шахматные фигуры: слон", R.drawable.bishop_white, false, -1, completed_lessons));
        data.add(new LessonItem("4", "1", "Knight", "Как ходят шахматные фигуры: конь", R.drawable.knight_white, false, -1, completed_lessons));
        data.add(new LessonItem("5", "1", "Rook", "Как ходят шахматные фигуры: ладья", R.drawable.rook_white, false, -1, completed_lessons));
        data.add(new LessonItem("6", "1", "Queen", "Как ходят шахматные фигуры: ферзь", R.drawable.queen_white, false, -1, completed_lessons));
        data.add(new LessonItem("7", "1", "Summary", "Как ходят шахматные фигуры: обобщение", R.drawable.book, false, -1, completed_lessons));
    }
